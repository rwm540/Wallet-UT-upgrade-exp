...
export const TransferModal: React.FC<TransferModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      ...
      <div className="relative bg-white w-full max-w-sm sm:max-w-md rounded-3xl p-4 sm:p-6 shadow-2xl border-t-4 border-teal-500 animate-in fade-in zoom-in duration-200 my-auto">
